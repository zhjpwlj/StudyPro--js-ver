...
// Updated to Lucide icon set for a modern and consistent look.

export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 5a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Z"/><path d="M12 5a3 3 0 1 0 5.993.13a3 3 0 0 0-5.993-.13Z"/><path d="M12 15a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Z"/><path d="M12 15a3 3 0 1 0 5.993.13a3 3 0 0 0 5.993-.13Z"/><path d="M15 12a3 3 0 1 0-5.993.13a3 3 0 0 0 5.993-.13Z"/><path d="M6 12a3 3 0 1 0 .13-5.993A3 3 0 0 0 6 12Z"/><path d="M18 12a3 3 0 1 0 .13-5.993A3 3 0 0 0 18 12Z"/><path d="M6 12a3 3 0 1 0 .13 5.993A3 3 0 0 0 6 12Z"/><path d="M18 12a3 3 0 1 0 .13 5.993A3 3 0 0 0 18 12Z"/><path d="M14 8.5v7"/><path d="M10 8.5v7"/><path d="M12 12h5.5"/><path d="M12 12H6.5"/><path d="M12 12l-2-2.5"/><path d="M12 12l2-2.5"/><path d="M12 12l-2 2.5"/><path d="M12 12l2 2.5"/>
    </svg>
);
...
export const TasksIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/><path d="m9 12 2 2 4-4"/>
    </svg>
);
...
export const HabitsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const StudyRoomIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m12 3-1.912 3.823-3.823 1.912 3.823 1.912L12 14.56l1.912-3.823 3.823-1.912-3.823-1.912L12 3z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/>
    </svg>
);

export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14.5 4.5c.997 1.649 1.5 3.5 1.5 5.5 0 2.5-1 5-2.5 6.5s-3.5 2.5-5.5 2.5c-2.5 0-5-1-6.5-2.5S.5 13.5 2 11c1-2.5 3.5-5 5.5-6.5C9.5 2 11.5 0 13 0c1.5 0 2.5 1.5 3 3 .5 1.5 0 3.5-1.5 5.5"/>
    </svg>
);
...
export const CalculatorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><line x1="16" x2="12" y1="18" y2="18"/><line x1="12" x2="12" y1="14" y2="18"/><line x1="12" x2="8" y1="14" y2="14"/>
    </svg>
);
...
export const AmbianceIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
