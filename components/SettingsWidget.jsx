...
import { useTheme, THEMES, WALLPAPERS } from '../hooks/useDarkMode.js';
                        ...
                        <div>
                            ...
                            <div className="flex space-x-4">
                                {Object.entries(THEMES).map(([key, theme]) => (
                                    <button key={key} onClick={() => setColorTheme(key)} className="flex flex-col items-center space-y-2">
                         ...
                         <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {Object.entries(WALLPAPERS).map(([key, wp]) => (
                                     <button key={key} onClick={() => setWallpaper(key)} className={`relative rounded-lg overflow-hidden aspect-video ring-2 ${wallpaper === key ? 'ring-primary-500' : 'ring-transparent'}`}>
