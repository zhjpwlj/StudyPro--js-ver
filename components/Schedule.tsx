...
import { ChevronLeftIcon, ChevronRightIcon, XIcon, PlusIcon, Trash2Icon } from './icons/Icons';
...
}> = ({ date, tasks, events, onClose, onAddEvent, onDeleteEvent }) => {
...
const Schedule: React.FC<ScheduleProps> = ({ tasks, events, setEvents }) => {
