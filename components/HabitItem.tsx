...
import { FireIcon, CheckIcon, PencilIcon, Trash2Icon, XIcon } from './icons/Icons';
...
const HabitItem: React.FC<HabitItemProps> = ({ habit, onComplete, onSelect, onDelete, onUpdate, isSelected }) => {
