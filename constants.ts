...
import { TasksIcon, HabitsIcon, ScheduleIcon, TimerIcon, JournalIcon, SparklesIcon, ClockIcon, CalculatorIcon, WeatherIcon, AmbianceIcon, SettingsIcon, GridIcon } from './components/icons/Icons';

export const WIDGET_HEADER_HEIGHT = 32; // h-8 in Widget.tsx is 2rem = 32px
